 ...
 *
 ******************************************************************************/
int HICMA_dgetrf_Tile(MORSE_enum uplo,
        MORSE_desc_t *AUV,
        MORSE_desc_t *AD,
        MORSE_desc_t *Ark,
 ...
 *
 ******************************************************************************/
int HICMA_dgetrf_Tile_Async(MORSE_enum uplo,
        MORSE_desc_t *AUV,
        MORSE_desc_t *AD,
        MORSE_desc_t *Ark,
        int rk, int maxrk, double acc,
...
*/
    ...
    hicma_pdgetrf(uplo, AUV, AD, Ark, sequence, request,
            rk, maxrk, acc
            );
