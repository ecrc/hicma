...
!*************************************************************************
 SUBROUTINE near_sca_hard_near_scheme(rj, nip, ntrain) bind(C, name="AL4SAN_near_sca")
  ...
  REAL(kind=dp)::coeffs(nipp,nipp),rp0(3),zeta10,zeta20,up0,vp0,&
                jacobo0,jacobo
    complex(c_double_complex), dimension(ntrain*nip):: rj                   
  ...
  OPEN(unit=5702,file='near_sca_hard_near_scheme_OldBasis_1_120.out')
