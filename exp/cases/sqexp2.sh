...
sizes="small"
if [ "$sizes" == "small"  ];then
nrows[1]=54000; nb[1]=2700; acc[1]=8;   maxrank[1]=29;
nrows[2]=81000; nb[2]=2700; acc[2]=8;   maxrank[2]=29;
nrows[3]=108000;    nb[3]=2700; acc[3]=8;   maxrank[3]=29;
nrows[4]=135000;    nb[4]=2700; acc[4]=8;   maxrank[4]=29;
nrows[5]=162000;    nb[5]=2700; acc[5]=8;   maxrank[5]=29;
nrows[6]=189000;    nb[6]=2700; acc[6]=8;   maxrank[6]=29;
nrows[7]=216000;    nb[7]=2700; acc[7]=8;   maxrank[7]=29;
nrows[8]=243000;    nb[8]=2700; acc[8]=8;   maxrank[8]=29;
nrows[9]=270000;    nb[9]=2700; acc[9]=8;   maxrank[9]=29;
nrows[10]=297000;   nb[10]=2700;    acc[10]=8;  maxrank[10]=29;
nrows[11]=324000;   nb[11]=2700;    acc[11]=8;  maxrank[11]=29;
nrows[12]=351000;   nb[12]=2700;    acc[12]=8;  maxrank[12]=29;
nrows[13]=378000;   nb[13]=2700;    acc[13]=8;  maxrank[13]=29;
nrows[14]=405000;   nb[14]=2700;    acc[14]=8;  maxrank[14]=29;
nrows[15]=432000;   nb[15]=2700;    acc[15]=8;  maxrank[15]=29;
nrows[16]=459000;   nb[16]=2700;    acc[16]=8;  maxrank[16]=29;
nrows[17]=486000;   nb[17]=2700;    acc[17]=8;  maxrank[17]=29;
nrows[18]=513000;   nb[18]=2700;    acc[18]=8;  maxrank[18]=29;
nrows[19]=540000;   nb[19]=2700;    acc[19]=8;  maxrank[19]=29;
nrows[20]=567000;   nb[20]=2700;    acc[20]=8;  maxrank[20]=29;
nrows[21]=594000;   nb[21]=2700;    acc[21]=8;  maxrank[21]=29;
...
step=1
_appdata="--ss"; timelimit="00:25:00"
...
note="Hicma beta=0.01 only dense matrix $_appdata - $sizes - $_wavek - $timelimit - $_compmaxrank "
