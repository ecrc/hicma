...
_ci=40; nrows[$_ci]=20740;   nb[$_ci]=1037;    acc[$_ci]="1e-6";   maxrank[$_ci]=50;  compmaxrank[$_ci]=100; appdata[$_ci]="--m-3D-rbf"; rad[$_ci]=-1; numobj[$_ci]=8; numsubobj[$_ci]=2; order[$_ci]=2; mesh_file[$_ci]="stars-h/SARS-CoV-2-meshes/S2data_20k/"; rbf_kernel[$_ci]="9";

_ci=41; nrows[$_ci]=207400   nb[$_ci]=3050;    acc[$_ci]="1e-6";   maxrank[$_ci]=50;  compmaxrank[$_ci]=100; appdata[$_ci]="--m-3D-rbf"; rad[$_ci]=-1; numobj[$_ci]=60; numsubobj[$_ci]=240; order[$_ci]=2; mesh_file[$_ci]="stars-h/SARS-CoV-2-meshes/S2data_200k/"; rbf_kernel[$_ci]="9"; 
