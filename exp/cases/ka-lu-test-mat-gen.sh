...
ic=59;nrows[$ic]=1440;  nb[$ic]=720;   acc[$ic]=2;   maxrank[$ic]=720;  compmaxrank[ $ic]=1440; appdata[ $ic]="--ss"; ntrian[$ic]=120; nipp[$ic]=12
...
ic=56;nrows[$ic]=7680;  nb[$ic]=2560;   acc[$ic]="4";   maxrank[$ic]=2560;  compmaxrank[ $ic]=3000; appdata[ $ic]="--ss"; ntrian[$ic]=2560; nipp[$ic]=3
ic=57;nrows[$ic]=1440;  nb[$ic]=480;   acc[$ic]=2;   maxrank[$ic]=480;  compmaxrank[ $ic]=1000; appdata[ $ic]="--ss"; ntrian[$ic]=120; nipp[$ic]=12
ic=58;nrows[$ic]=2400;     nb[$ic]=800;     acc[$ic]=3;   maxrank[$ic]=800;   compmaxrank[ $ic]=1600; appdata[ $ic]="--ss" ntrian[$ic]=400 nipp[$ic]=6
...
nprocs="1"; allcaseids[1]="59" #56 
#nprocs="4"; allcaseids[4]="59" #56 
