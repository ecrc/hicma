...
void HICMA_TASK_duncompress(const MORSE_option_t *options,
...
// CODELETS(duncompress_hcore, 3, cl_duncompress_hcore_cpu_func, cl_duncompress_hcore_cuda_func, STARPU_CUDA_ASYNC)
//#endif
