...
int dtrsm_print_index_end = 0;
//#if defined(HICMA_DOUBLE)
#undef  CBLAS_SADDR
#define CBLAS_SADDR(_val) (_val)
void HICMA_TASK_dtrsm(const MORSE_option_t *options,
...
static void cl_dtrsm_hcore_cpu_func(void *descr[], void *cl_arg)
{
    ...
    cblas_dtrsm(
                ...
                B, ldb);
    if(HICMA_get_print_index() == 1 || HICMA_get_print_index_end() == 1 || dtrsm_print_index_end){
