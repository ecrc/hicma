...
{
    struct starpu_codelet *codelet = &cl_zgenrhs;
...
/*   cl_zgenrhs_cpu_func - Generate a tile for random matrix. */

#if !defined(CHAMELEON_SIMULATION)
static void cl_zgenrhs_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    double *A, *mesh;
 ...
 * Codelet definition
 */
CODELETS_CPU(zgenrhs, 1, cl_zgenrhs_cpu_func)
